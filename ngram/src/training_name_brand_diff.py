...
positives_training_file = path_data + "ngram_positive_training_samples_formatted_lem.csv"
negatives_training_file = path_data + "ngram_negative_training_skus_formatted_lem.csv"
