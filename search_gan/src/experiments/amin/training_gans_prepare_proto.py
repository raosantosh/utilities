...
cid='101'
positives_training_file = path_data + "positive_training_samples_query_productname_stemmed_"+cid+".csv"
negatives_training_file = path_data + "negative_training_samples_query_productname_stemmed_"+cid+".csv"
# positives_validation_file = path_data + "positive_training_samples_query_productname_stemmed_131.csv"
# negatives_validation_file = path_data + "negative_training_samples_query_productname_stemmed_131.csv"
...
outputproto_train = path_data + "positive_negative_1p_7n_32_partner"+cid+"_train.proto"
outputproto_validaton  =  path_data + "positive_negative_1p_7n_32_partner"+cid+"_val.proto"
outputproto_test  =  path_data + "positive_negative_1p_7n_32_partner"+cid+"_test.proto"
...
writer_train = tf.python_io.TFRecordWriter(outputproto_train)
writer_val = tf.python_io.TFRecordWriter(outputproto_validaton)
writer_test = tf.python_io.TFRecordWriter(outputproto_test)
...
for batch_index in range(num_batches):
    ...
    if (batch_index +1)%10  == 0:
        writer_val.write(serialized_batch)
    elif batch_index%10 ==0:
        writer_test.write(serialized_batch)
    else:
        writer_train.write(serialized_batch)
